    ...
    <>
      <div>
        ...
        <div className={styles.darkcyan_1}>
          <p>
            <strong>Give $150 in Gift Cards, earn a $25 Promo Card! Ends 6/19.</strong>{" "}
            <u
              onClick={() => {
                navigate("https://www.nordstromrack.com/ship-return-policy");
              }}
            >
              Gift Cards & Restrictions
            </u>
          </p>

          <div style={{ float: "left", backgroundColor: "black" }} href="#"><img alt="" src="https://n.nordstrommedia.com/alias/IN.gif" /><span>India</span></div>
        </div>
